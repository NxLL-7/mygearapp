        ...
        <div className="about-header">
          <div className="about-header-left">
            ...
            <p className="about-header-count">
              {gadgets.length} {gadgets.length === 1 ? "item" : "items"} in
              collection
            </p>
          </div>
          {gadgets.length > 0 && (
          ...
          {gadgets.length === 0 ? (
            ...
            <div className="gadgets-grid about-grid">
              {gadgets.map((gadget, index) => {
                const isFav =
                  gadget.favorite || gadget.is_favorite || gadget.isFavorite;
                return (
                  <div
                  ...
                  >
                    <div className="about-card-header">
                      ...
                      {isFav && (
                        <div
                          className="about-fav-indicator"
                          title="Favorite"
                          aria-label="Favorite gadget"
                        >
                          <svg
                            width="16"
                            height="16"
                    ...
                    <p
                      ...
                      title={gadget.gadget_description}
                    >
                      {gadget.gadget_description}
                    </p>
                    {gadget.gadget_description &&
                      gadget.gadget_description.length > 80 && (
                        <button
        ...
        >
          ...
          >
            ...
            <div className="manage-modal-actions">
              <Link
                to="/add-gadget"
                className="manage-action-btn manage-action-add"
              >
                ...
                <div className="manage-action-text">
                  ...
                  <span className="manage-action-desc">
              ...
              <Link
                to="/favorite-gadget"
                className="manage-action-btn manage-action-fav"
              >
                <div className="manage-action-icon">
                  <svg
                    width="20"
        ...
        >
          ...
          >
            <div className="detail-modal-badge">
              ...
              <span>
                {selectedDetailGadget.gadget_product_name || "Unknown Product"}
              </span>
            </div>
